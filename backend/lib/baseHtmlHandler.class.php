...
.theme--templateuse .main-column hr, .theme--templateuse .container hr, .theme--templateuse hr {
    border-color: #111111;
}
...
.main-column ol li, .theme--templateuse .container ol li, .theme--templateuse .text p, .theme--templateuse .card p, .theme--templateuse
